package com.example.navigationdraweractivity.ui.recipe;
...
public class UtubeAdapter extends RecyclerView.Adapter<UtubeAdapter.UtubeViewHolder> {
    ...
    @NonNull
    @Override
    public UtubeViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {


        //item_utube xml파일을 객체화 시킨다.
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.youtube_list, viewGroup, false);
        UtubeViewHolder holder = new UtubeViewHolder(view);

        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull UtubeViewHolder viewholder, int position) {

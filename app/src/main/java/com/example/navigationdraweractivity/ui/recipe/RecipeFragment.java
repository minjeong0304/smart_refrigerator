...
import com.example.navigationdraweractivity.databinding.FragmentRecipeBinding;
...
public class RecipeFragment extends Fragment {
    ...
    final String serverKey="AIzaSyC4zQ4PteIwvmYff4IrWiK2hw-FGzHHsDY";
    ...
    private class searchTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            utubeAdapter = new UtubeAdapter(getActivity(), sdata);
